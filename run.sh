codeball2018-linux/codeball2018 --p1-name CUR-STRAT --p2-name PREV-STRAT --p2 tcp-31002 --noshow --results-file res.txt --duration 7200 &
# codeball2018-linux/codeball2018 --p1-name CUR-STRAT --p2-name PREV-STRAT --p2 tcp-31002 --results-file res.txt &
sleep 1; cpp-cgdk/versions/MyStrategy_v8_beta &
